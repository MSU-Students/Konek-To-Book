...
<!--------------------------------  ADD NEW BORROWER BUTTON  ------------------------------------------    --->
         ...
         <q-dialog v-model="addAccount" persistent>
          ...
          <q-card-section class="q-gutter-md row">
                ...
                <div class="col">
                <q-input dense outlined v-model="bdate" type="date" label="Birth Date" />
                </div>
            </q-card-section>
           ...
           <q-card-section class="q-gutter-md">
                    ...
                    <q-input  dense outlined v-model="password"  :type="isPwd ? 'password' : 'text'" label="Password">
...
<template v-slot:body="props">
 ...
 <!------------------------------------- EDIT BORROWER BUTTON   ------------------------------------------    --->
          ...
          <q-card-section class="q-gutter-md">
                   <q-input dense outlined v-model="userid" readonly  label="User ID" />
          </q-card-section>
...
const columns = [
  ...
  { name: 'gender', label: 'Gender', align: 'center', field: 'gender',sortable: true },
  ...
  { name: 'usertype', label: 'User Type', align: 'center', field: 'usertype' },
...
export default {
  setup () {
    ...
    const options1 = ref(['Admin', 'Librarian'])
