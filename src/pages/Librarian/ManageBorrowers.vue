...
<!--------------------------------  ADD NEW BORROWER BUTTON  ------------------------------------------    --->
         ...
         <q-dialog v-model="addBorrower" persistent>
             <q-card style="width: 800px; max-width: 100vw" class="q-pa-md">
                ...
                <div class="col">
                 <q-input dense outlined v-model="studentid" label="Student ID" />
                </div>
              </q-card-section>
              ...
              <q-card-section class="q-gutter-md row">
                ...
                <div class="col">
                 <q-input dense outlined v-model="middlename" label="Middle Name" />
                </div>
                 <div class="col">
              ...
              <q-card-section class="q-gutter-md row">
                <div class="col">
                <q-input dense outlined v-model="yearlevel" label="Year/Level" />
                </div>
                <div class="col">
                <q-input dense outlined v-model="contact" label="Contact Number" />
                </div>
                <div class="col">
                 <q-select
                      outlined
...
<template v-slot:body="props">
 ...
 <!------------------------------------- EDIT BORROWER BUTTON   ------------------------------------------    --->
              ...
              <q-dialog v-model="editRow" persistent>
                ...
                <q-card-section class="q-gutter-md row">
                <div class="col">
                 <q-input dense outlined v-model="borrowerid" readonly  label="Borrower ID" />
                </div>
                <div class="col">
                 <q-input dense outlined v-model="studentid" label="Student ID" />
                </div>
...
const columns = [
  ...
  { name: 'studentID', align: 'center', label: 'Student ID', field: 'studentID', sortable: true },
  {
    name: 'desc',
    required: true,
    label: 'First Name',
  ...
  { name: 'lastname', label: 'Last Name', align: 'center', field: 'lastname', sortable: true },
  { name: 'yearlevel', label: 'Year/Level', align: 'center', field: 'yearlevel',sortable: true },
  { name: 'contact', label: 'Contact Number', align: 'center', field: 'contact'},
  { name: 'issudebookid', label: 'IssuedBook ID', align: 'center', field: 'issudebookid' },
...
export default {
  setup () {
    ...
    const options = ref(['001', '002', '003','004', '008', '006'])
