         ...
         <q-dialog v-model="addIssuedBook" persistent full-width>
             <q-card style="width: 800px; max-width: 100vw" class="q-pa-md">
              ...
              <q-card-section class="q-gutter-md row">
                ...
                <div class="col">
                   <q-input dense outlined v-model="title" readonly label="Title" />
                </div>
             </q-card-section>
            ...
            <q-card-section class="q-gutter-md row">
                ...
                <div class="col-md-4">
                   <q-input dense outlined v-model="borrowername" readonly label="Borrower Name" />
                </div>
                 <div class="col">
                  <q-input dense outlined v-model="borrowdate" type="date" label="Borrow Date" />
                </div>
                <div class="col">
                   <q-input dense outlined v-model="duedate" type="date" label="Due Date" />
                </div>
             </q-card-section>

           <q-card-section class="q-gutter-md row">
                 <div class="col">
                   <q-input outlined dense v-model="bookstatus" readonly label="Book Status" />
                </div>
                <div class="col">
                  <q-select
                      outlined
...
<template v-slot:body="props">
 ...
 <!------------------------------------- EDIT ISSUEDBOOK BUTTON   ------------------------------------------    --->
              ...
              <q-card-section class="q-gutter-md row">
                 <div class="col-md-3">
                   <q-input dense outlined v-model="issuedbookid" readonly label="IssuedBook ID" />
                </div>
                <div class="col-md-3">
                  <q-select
                      outlined
...
const columns = [
   { name: 'issuedbookID', align: 'center', label: 'IssuedBook ID', field: 'issuedbookID', sortable: true },
   { name: 'bookID', align: 'center', label: 'Book ID', field: 'bookID', sortable: true },
   { name: 'borrowerID', align: 'center', label: 'Borrower ID', field: 'borrowerID', sortable: true },
  {
    name: 'desc',
    required: true,
    label: 'Title',
  ...
  { name: 'borrowdate', label: 'Borrow Date', align: 'center',field:'borrowdate'},
  { name: 'duedate ', label: 'Due Date', align: 'center',field: 'duedate'},
  { name: 'bookstatus', label: 'Book Status', align: 'center', field: 'bookstatus'},
  { name: 'issuedbookstatus', label: 'IssuedBook Status', align: 'center', field: 'issuedbookstatus' },
  { name: 'bookfinesid', label: 'BookFines ID', align: 'center', field: 'bookfinesid' },
];
...
export default {
  setup () {
    ...
    const addIssuedBook = ref(false)
    const editRow = ref(false)
    const filter = ref('')
    const dialog = ref (false)

    const issuedbookid = ref('')
    const bookid = ref('')
    ...
    const issuedbookstatus = ref('')
    const bookfinesid = ref('')

    const options1 = ref(['001', '02', '003','006','078','0672','0898','04332'])
    const options2 = ref(['01', '02', '03','04','05','06','021', '034'])
    const options3 = ref(['Lost', 'Issued/Borrow', 'Return'])
    const options4 = ref(['001', '002', '003','004', '005','021','034'])
